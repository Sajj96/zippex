@extends('layouts.master', ['title' => ' Roles | Add Role'])
            ...
            <div class="card">
                ...
                <div class="body">
                    <form method="POST" action="{{ route('role.edit') }}">
                        ...
                        <button type="submit" class="btn btn-raised btn-primary waves-effect submit-btn">Add Role</button>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card px-4"  style="border: 1px solid #ced4da;">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="checkbox">
                                            <input id="{{ $perm['pem'] }}" type="checkbox" class="permissions" name="permissions[]" value="{{ $perm['pem'] }}">
