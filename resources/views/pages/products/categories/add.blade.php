@extends('layouts.master', ['title' => 'Products | Add Category'])
    ...
    <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('product.category') }}">Product Categories</a></li>
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Add Product</strong> Category</h2>
                </div>
                <div class="body">
